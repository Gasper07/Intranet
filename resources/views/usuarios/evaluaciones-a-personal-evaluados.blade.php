          ...
          @if(Session::has('Evaluacion_Users'))
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ProfileFotosStarts profilesUsersFinish">
              ...
              <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 detallImgProfile profileSession">              
                <div class="label dataPrubeIm dataProfileEvaluacionesDetallUser" style="background-image: url('http://app-7983e06f-f506-428d-aef9-aea82667c6d7.cleverapps.io/public/assets/profiles/{{Session::get('Evaluacion_UsersFoto')}}')"></div>
              </div>  
                         ...
                         @if($evaluaciones->proxima_evaluacion > $MesActual)
                           @if($evaluaciones->mes_evaluacion == $MesActual)
                             ...
                             <a href="evaluacion-a-personal/{{ $encargados->id_encargardo }}/{{$users->id_usuario}}" class="UserYarealizo">
                              <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="label dataPrubeIm dataProfileEvaluacionesEvaluados" style="background-image: url('http://app-7983e06f-f506-428d-aef9-aea82667c6d7.cleverapps.io/public/assets/profiles/{{ $users->foto }}')"></div>
