<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 geleriFotosUser fotoUserFake">
  ...
  @foreach($arrayOfImages as $DataImages => $valuDateImages)
    ...
    @for($ga=0; $ga < $canditdadImagesForArray; $ga++ )
      <p class="gasper">{{ $GetImage  = \Storage::disk('ubUploadsChange')->get('/documents/'.$DataImages[$ga]['imagesGalery'].'') }}</p>
      <img class="img-responsive clImgView" src="data:{{ $DataImages[$ga]['mime'] }};base64,{{ base64_encode($GetImage) }}" alt=""  data-toggle="modal" data-target="#myModalswPost">
        ...
        <div class="modal-dialog dialoDataImgen" role="document">
          <div class="modal-content">
            <div class="modal-body">
              <img class="img-responsive" src="data:{{ $DataImages[$ga]['mime'] }};base64,{{ base64_encode($GetImage) }}" alt="">
            </div>
